...
test('It should allow the input value to be deleted', () => {
  render(<Index />);
...
test('It should not allow start with more than one 0', () => {
  render(<Index />);
...
test('It should not allow value with more than 3 digits', () => {
  render(<Index />);
